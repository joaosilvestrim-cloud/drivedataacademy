...
export default async function ProfilePreview({userId,email}:{userId:string;email?:string|null}) {
  ...
  if(available) summary=developed?`${developed} competências com evidências registradas. Explore seu histórico e descubra os próximos caminhos.`:'Seu universo está pronto para receber as primeiras evidências de aprendizagem.';
