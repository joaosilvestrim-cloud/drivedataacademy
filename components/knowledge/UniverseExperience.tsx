  ...
  return <div className={styles.app}>
    ...
    <div className={styles.workspace}>
      <aside className={`${styles.sidebar} ${filters ? styles.sidebarOpen : ''}`}>
        ...
        <div className={styles.sidebarBottom}><span className={styles.smallOrbit}><Sparkles size={20} /></span><strong>Seu próximo passo começa<br />com uma conexão.</strong><p>Explore o que você já desenvolveu e descubra novos caminhos.</p><Link href="/conta/cursos">Conhecer treinamentos <ArrowUpRight size={15} /></Link>{!isDemo && <Link href="/conta/diagnostico">Diagnóstico de entrada <ArrowUpRight size={15} /></Link>}</div>
