...
function Sem3D(){const tr=usarTraducao();return <div className={s.loading}>{tr("3D indisponível neste dispositivo. Continue pela visão 2D ou pelos botões das etapas abaixo.")}</div>;}
