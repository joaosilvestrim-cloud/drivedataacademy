...
export type Summary = { available: boolean; developed: number; advanced: number; cooling: Cooling[] };

const EMPTY: Summary = { available: false, developed: 0, advanced: 0, cooling: [] };
