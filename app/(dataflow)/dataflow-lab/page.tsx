...
export default async function Page(){const {data:{user}}=await createClient().auth.getUser();if(!user)redirect('/entrar?next=/dataflow-lab');return <DataFlowLab key={user.id}/>;}
