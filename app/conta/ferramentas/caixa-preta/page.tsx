  ...
  return (
    <div>
      ...
      <section className="mt-12 grid gap-5 rounded-3xl border border-white/8 bg-white/[0.02] p-6 sm:grid-cols-3">
        <div>
          <p className="text-sm font-semibold text-brand-green">{tr("Por que um modelo pequeno")}</p>
        ...
        <div>
          <p className="text-sm font-semibold text-brand-green">{tr("O que muda no seu trabalho")}</p>
          <p className="mt-1 text-sm text-slate-400">
        ...
        <div>
          <p className="text-sm font-semibold text-brand-green">{tr("Nada sai daqui")}</p>
          <p className="mt-1 text-sm text-slate-400">
