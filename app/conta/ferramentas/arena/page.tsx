  ...
  return (
    <div>
      ...
      <section className="mt-12 grid gap-5 rounded-3xl border border-white/8 bg-white/[0.02] p-6 sm:grid-cols-3">
        <div>
          <p className="text-sm font-semibold text-brand-green">Banco de verdade, no seu navegador</p>
          <p className="mt-1 text-sm text-slate-400">
            É um SQLite completo rodando na sua máquina. A sua consulta é executada mesmo, não comparada com texto.
          </p>
        </div>
        <div>
          <p className="text-sm font-semibold text-brand-green">Sem gabarito escrito por ninguém</p>
          <p className="mt-1 text-sm text-slate-400">
            A resposta certa é calculada na sua base, na hora. Por isso cada aluno tem números próprios e a resposta do
            colega não serve.
          </p>
        </div>
        <div>
          <p className="text-sm font-semibold text-brand-green">O caminho é seu</p>
          <p className="mt-1 text-sm text-slate-400">
