...
const GROUPS: { title: string | null; items: { label: string; href: string; icon: string }[] }[] = [
  { title: null, items: [{ label: "Visão geral", href: "/admin", icon: "overview" }] },
  {
    ...
    items: [
      ...
      { label: "Uso da plataforma", href: "/admin/uso", icon: "analytics" },
      { label: "Analytics de alunos", href: "/admin/analytics", icon: "analytics" },
  ...
  },
  {
    title: "Marketing",
    items: [
      { label: "Parceria & Negócios", href: "/admin/representacao", icon: "leads" },
