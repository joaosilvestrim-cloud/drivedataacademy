      ...
      <main className="relative grid min-h-screen place-items-center px-6">
        <div className="w-full max-w-sm">
          ...
          <div className="glass-strong rounded-3xl border border-white/10 p-8 text-center">
            ...
            <h1 className="mt-4 font-display text-2xl font-bold text-white">{tr("Sua conta vem com a assinatura")}</h1>
            <p className="mt-2 text-sm text-slate-300">
              {tr("A conta na plataforma é criada automaticamente assim que sua assinatura é confirmada. É só assinar e você recebe um e-mail para definir a senha.")}
            </p>
            ...
            <p className="mt-5 text-sm text-slate-400">
              {tr("Já tem conta?")} <Link href="/entrar" className="font-medium text-brand-green hover:underline">{tr("Entrar")}</Link>
            </p>
          </div>
        </div>
      </main>
