  ...
  return (
    <main className="mx-auto flex min-h-[70vh] max-w-xl flex-col justify-center px-6 py-20">
      ...
      <p className="mt-3 text-body text-ds-text-2">
        {tr("A falha foi do nosso lado, não do seu. Tente de novo em alguns instantes. Nada do que você já fez foi perdido.")}
      </p>
      ...
      {error.digest && (
        <p className="mt-8 font-mono text-caption text-ds-text-3">
          {tr("Se precisar falar com o suporte, informe este código:")} {error.digest}
        </p>
      )}
    </main>
  );
